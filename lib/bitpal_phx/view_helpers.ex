defmodule BitPalPhx.ViewHelpers do
  @moduledoc false
  ...
  def address_with_meta(invoice, opts \\ []) do
    recipent =
      Keyword.get(opts, :recipent) || Application.get_env(:demo, :recipent_description, "")

    uri_encode(uri_address(invoice.address), uri_query(invoice, recipent))
  end
